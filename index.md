...
-	National Standard for Identiteters Sikringsniveauer [17], som definerer et tillidsrammeværk for digitale identiteter som dækker fysiske personer, juridiske enhender og fysiske personer associeret med en juridisk enhed.
...
- I en række cloud-tjenester (fx hos Microsoft) sker valg af IdP indirekte ved, at brugeren skal taste sin emailadresse, som så kan oversættes til en relevant IdP baseret på registreringer om domænet.
...
| udsteder af identifikationsmidler | se eletronisk idetifikationsordning |   |   |
