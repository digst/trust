...
Nogle apparater, som sensorer og aktuatorer kan direkte blive påvirket af- eller påvirke det fysiske miljø omkring dem. Det kan eksempelvis være et netværkstilknyttet termometer, som kan aflæses på en smartphone eller en automatisk garageåbner der kan registere når den rigtige bil kommer tæt på. Det kan også være en kompliceret  blanding, som vi ser der i moderne biler eller industrirobotter, med mange typer sensorer og aktuatorer der bliver koordineret centralt. Dem vælger vi at kalde aktive apparater. Ved siden af de aktive apparater står de passive. Passive apparater er ikke i stand til at ændre en tilstand i verden på egen hånd, men kan bære på funktioner og information, der kan være en udløsende faktor for ændringer i verden. Eksempelvis indeholder moderne pas information om biometrisk data, der linker identiteten med entiteten, og som kan aflæses af andre apparater.

Fordi aktive apparater kan gennemføre fysiske forandringer i deres omverden og indsamle information, er der en reel risiko for brud på private datas fortrolighed, afbrydelser af kritiske services samt fysisk skade på personer eller materiel. Det betyder, at brugerstyring og yderligere tanke på sikkerhed bør indgå i opsætningen og driften af apparater.
...
IETF [44] deler et apparats livscyklus op i tre faser. Først "bootstrapping", hvor apparatet sættes op, til at kunne udføre sin opgave og indgå som tiltænkt i den samlede infrastruktur. Her skal man være særligt opmærksom på om det apparat man sætter op er personligt eller bliver delt af flere brugere, og om der bliver indsamlet personlige oplysninger der skal kobles til en konkret bruger. Dernæst "operational" fasen, hvor apparatet udfører sin funktion. Hvis der er behov for en forandring bliver den sidste fase, der kaldes "Maintainance & rebootstrapping" relevant. Det er særligt i bootstrappingfaserne at man skal være opmærksom på brugerstyring. Det er vigtigt at påpege, at afskaffelse af apparater også tæller som en Maintainance & rebootstrapping fase, og at man altså bør sikre, at apparatet ikke længere har rettigheder, indflydelse eller indeholder fortrolig data.

I mange tilfælde vil der ikke være en særlig kobling mellem en specifik instans af et apparats hardware og software. Dog er der tilfælde hvor rettighederne for et apparat som bruger er knyttet til en specifik instans af appartets hardware. Eksempelvis har anvender teleselskaber en mobiltelefons unikke IMEI-nummer til at give mobiltelefonens software adgang til mobilnetværket, under det rette abonnement. Hvis man skal etablere bruger- rettighedsstyring på baggrund af en unik hardware identifikator, kræver det at, det specifikke apparat har en unik identifikator, at det bliver registreret som en af apparatets attributter i bootstrappingprocessen og at attributten kan forstås ved adgangskontol. Dette påvirker derfor både attributsæt og adgangspolitikker i det miljø apparatet skal agere i.
